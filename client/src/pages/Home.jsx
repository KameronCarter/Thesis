                        ...
                        <div className="main-container">
                            <section className="content">
                                ...
                                <p className="left-section">
                                    ...
                                    this site is targeted towards college students, financial literacy is important for people of all ages.
                                </p>
                                <hr />

                                <h4 className="right-section">Three Components</h4>

                                <p className="right-section">
                                    The first component, <strong>financial knowledge</strong>, refers to an individual's understanding of financial concepts and products.
                                    The next component, <strong>financial behavior</strong>, refers to the actions individuals take regarding their finances, such as budgeting,
                                    saving, and investing. Last but not least, <strong>financial attitude</strong>, refers to an individual's mindset and beliefs about money and finances.
                                ...
                                <h4>The Importance of Financial Literacy in College Students</h4>
                                <p className="left-section">
                                    ...
                                    can most benefit from financial literacy education due to the fact that college debt is at an all time high. Being financially literate can help
                                    you navigate the complexities of student loans, credit cards, and budgeting for the first time. It can also help you avoid common financial pitfalls
